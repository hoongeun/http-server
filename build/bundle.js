...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__server__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mobile_detect__ = __webpack_require__(11);
...
const server = Object(__WEBPACK_IMPORTED_MODULE_0__server__["a" /* createHttpServer */])((req, res) => {
  console.log(`${new Date().toISOString()} - ${req.method} ${req.url}`);
  if (req.url == '/') {
    const md = new __WEBPACK_IMPORTED_MODULE_3_mobile_detect___default.a(req.headers['user-agent']);
    const page = md.mobile() ? 'static/mobile.html' : 'static/desktop.html';
    const filePath = __WEBPACK_IMPORTED_MODULE_2_path___default.a.resolve(__WEBPACK_IMPORTED_MODULE_2_path___default.a.join('.', page));
    __WEBPACK_IMPORTED_MODULE_1_fs___default.a.createReadStream(filePath).pipe(res);
  } else if (req.url === '/static/desktop.jpg') {
    const filePath = __WEBPACK_IMPORTED_MODULE_2_path___default.a.resolve(__WEBPACK_IMPORTED_MODULE_2_path___default.a.join('.', req.url));
    __WEBPACK_IMPORTED_MODULE_1_fs___default.a.createReadStream(filePath).pipe(res);
  } else if (req.url === '/static/mobile.jpg') {
    const filePath = __WEBPACK_IMPORTED_MODULE_2_path___default.a.resolve(__WEBPACK_IMPORTED_MODULE_2_path___default.a.join('.', req.url));
    __WEBPACK_IMPORTED_MODULE_1_fs___default.a.createReadStream(filePath).pipe(res);
  } else if (req.url === '/favicon.ico') {
    const filePath = __WEBPACK_IMPORTED_MODULE_2_path___default.a.resolve(__WEBPACK_IMPORTED_MODULE_2_path___default.a.join('.', 'static', req.url));
    __WEBPACK_IMPORTED_MODULE_1_fs___default.a.createReadStream(filePath).pipe(res);
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_net__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_net___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_net__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__httpHandler__ = __webpack_require__(6);



class HttpServer extends __WEBPACK_IMPORTED_MODULE_0_net___default.a.Server {
  constructor() {
    super();
    this.on('connection', stream => {
      stream.on('error', () => {});
      const hh = new __WEBPACK_IMPORTED_MODULE_1__httpHandler__["a" /* default */]((req, res) => {
...
/* unused harmony default export */ var _unused_webpack_default_export = (HttpServer);
const createHttpServer = cb => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = createHttpServer;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_stream__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__request_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__response_js__ = __webpack_require__(8);
...
class HttpHandler extends __WEBPACK_IMPORTED_MODULE_0_stream___default.a.Duplex {
  constructor(cb) {
    super();
    this.request = new __WEBPACK_IMPORTED_MODULE_1__request_js__["a" /* default */]();
  ...
  _prepareRequest() {
    ...
    const res = this.response = new __WEBPACK_IMPORTED_MODULE_2__response_js__["a" /* default */](req);
    res._onfinish = () => {
      if (res._buffer) {
  ...
  _write(buf, enc, next) {
    ...
    for (const len = buf.length; i < len; i++) {
      ...
      if (buf[i] === LF) {
        ...
        if (this._state === states.VALUE) {
          req._setHeader(this._keyName, buf.slice(this._lastIndex, i));
          this._keyName = null;
          this._lastIndex = i;
          this._state = states.KEY;
        } else
        if (this._state === states.KEY) {
          this._lastIndex = i;
        }
      } else
      if (this._state === states.KEY && buf[i] === 58) {
...
/* harmony default export */ __webpack_exports__["a"] = (HttpHandler);
...
class Response extends __WEBPACK_IMPORTED_MODULE_0_stream___default.a.Writable {
  constructor(req) {
    super(req);
    this.statusCode = 200;
    this._request = req;
